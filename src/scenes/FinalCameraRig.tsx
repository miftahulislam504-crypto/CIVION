...
const PATH_START = new THREE.Vector3(0, 10, 22);
const PATH_END = new THREE.Vector3(0, 95, 75);

const PARALLAX_STRENGTH = new THREE.Vector2(1.2, 0.8);
const LOOK_SMOOTHING = 0.06;

export default function FinalCameraRig() {
